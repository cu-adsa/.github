...
| 2 | L18 | Linked Lists | Insertion and deletion in a linked list | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, PPT, Code, Simulation | CO2 | BT3 |
| 2 | L19 | Linked Lists | Header linked list and doubly linked list | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, PPT, Code, Infographics | CO2 | BT3 |
| 2 | L20 | Linked Lists | Circular linked list and circular doubly linked list | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, PPT, Code, Simulation | CO2 | BT3 |
| 2 | L21 | Linked Lists | Operations on doubly linked list; complexity analysis and applications | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Case Study, Code, Reports | CO1, CO2 | BT4 |
...
| Unit No | Lecture No | Chapter Name | Topic | Text/Reference Books | Pedagogical Tools | Mapped CO(s) | BT Level |
|---------|------------|--------------|-------|----------------------|-------------------|--------------|----------|
| 3 | L42 | Hashing & File Organization | Hash tables and hash functions | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, PPT, Code, Infographics | CO2 | BT3 |
| 3 | L43 | Hashing & File Organization | Collision resolution strategies (chaining, linear probing) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, PPT, Code, Simulation | CO2, CO3 | BT5 |
| 3 | L44 | Hashing & File Organization | File organization — sequential, relative, index sequential, inverted file | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, PPT, Infographics, Video Lecture | CO2, CO4 | BT6 |
| 3 | L45 | Hashing & File Organization | Recap — designing efficient data systems (real-world applications) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Case Study, Code, Reports | CO4, CO5 | BT6 |
...
|---------|--------|-----------------|---------------|----------------------|-------------------|--------------|----------|
| 1 | E1 | Search in Rotated Sorted Array (#33) — Binary Search | [LC #33](https://leetcode.com/problems/search-in-rotated-sorted-array/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Case Study, Simulation | CO1, CO5 | BT4 |
| 1 | E2 | Sort an Array (#912) — Merge Sort / Quick Sort | [LC #912](https://leetcode.com/problems/sort-an-array/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Case Study, Simulation | CO1, CO5 | BT4 |
| 1 | E3 | Group Anagrams (#49) — Hash Table & Collision Resolution | [LC #49](https://leetcode.com/problems/group-anagrams/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Simulation, Reports | CO2, CO3 | BT5 |
| 1 | E4 | Kth Largest Element in an Array (#215) — Quick Sort / Divide & Conquer | [LC #215](https://leetcode.com/problems/kth-largest-element-in-an-array/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Case Study, Simulation | CO3, CO5 | BT5 |
| 2 | E5 | Swap Nodes in Pairs (#24) — Linked List Operations | [LC #24](https://leetcode.com/problems/swap-nodes-in-pairs/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Simulation, Reports | CO2 | BT3 |
| 2 | E6 | Evaluate Reverse Polish Notation (#150) — Stack & Postfix | [LC #150](https://leetcode.com/problems/evaluate-reverse-polish-notation/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Case Study, Simulation | CO2, CO3 | BT5 |
| 2 | E7 | Number of Islands (#200) — BFS & DFS Graph Traversal | [LC #200](https://leetcode.com/problems/number-of-islands/) | T-Introduction to Algorithms, T-Guide to Competitive Programming, T-The Algorithm Design Manual, R-Competitive Programming | Activity, Code, Case Study, Simulation | CO2, CO3 | BT5 |
